 ...
 * @return Negative if a < b, zero if a == b, positive if a > b
 */
static inline int compare_i8(const void* a, const void* b) {
    return (int)(*(const i8*)a) - (int)(*(const i8*)b);
}
 ...
 * @return Negative if a < b, zero if a == b, positive if a > b
 */
static inline int compare_i16(const void* a, const void* b) {
    return (int)(*(const i16*)a) - (int)(*(const i16*)b);
}
 ...
 * @return Negative if a < b, zero if a == b, positive if a > b
 */
static inline int compare_i64(const void* a, const void* b) {
    i64 va = *(const i64*)a;
    i64 vb = *(const i64*)b;
 ...
 * @return Negative if a < b, zero if a == b, positive if a > b
 */
static inline int compare_u16(const void* a, const void* b) {
 ...
 */
static inline int array_linear_search(const void* array, size_t count, size_t item_size, const void* key, int(*compare)(const void*, const void*)) {
 ...
 */
static inline void* array_min(void* array, size_t count, size_t item_size, int(*compare)(const void*, const void*)) {
    if (count == 0) {
        return NULL;
    }
 ...
 */
static inline void* array_max(void* array, size_t count, size_t item_size, int(*compare)(const void*, const void*)) {
    if (count == 0) {
        return NULL;
    }
