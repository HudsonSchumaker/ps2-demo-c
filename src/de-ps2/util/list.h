...
/**
 * @brief Remove an item from the list by index
 * @param list Pointer to the list
...
/**
 * @brief Remove the first item matching a value using a comparator function
 * @param list Pointer to the list
 * @param value Pointer to the value to compare against
 * @param comparator Comparison function that returns 0 when items are equal
